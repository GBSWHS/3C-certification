    ...
    <div className="w-screen">
      ...
      <div className="inline-block text-center w-full align-top p-10">
        <div className="text-center">
          <h1 className="text-center text-4xl font-bold border-b-2 inline-block p-2">로그아웃</h1>
        </div>

        <div className="border-2 inline-block p-10 mt-10">
          <b>정말 로그아웃 하시겠습니까?</b>
          <div className="flex gap-3 pt-5">
            <button className="text-white bg-red-400 hover:bg-red-500 hover:text-white py-2 px-5 font-bold cursor-pointer" onClick={logout}>로그아웃</button>
