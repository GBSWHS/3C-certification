        ...
        <div className="inline-block w-full align-top p-10 container">
          ...
          <div className="mt-10">
            {!error && data?.success && data?.type === true
              ? <Link href="/cms/notice_write" passHref><span className="text-white bg-blue-400 hover:bg-blue-500 hover:text-white py-2 px-5 font-bold cursor-pointer">공지 작성</span></Link>
              : <></>}
          </div>
        </div>
      </div>
